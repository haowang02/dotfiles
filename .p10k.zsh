# Generated by Powerlevel10k configuration wizard on 2025-07-07 at 13:31 CST.
...
() {
  ...
  function prompt_user_defined_hostname() {
    p10k segment -b 7 -f 0 -i '󰇄' -t "$USER_DEFINED_HOSTNAME"
  }
  ...
  #   - always:   Trim down pr2mpt when accepting a command line.
